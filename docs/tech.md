...
- `/attr`: Look up attribute `attr` in the **current** module.
- `/child/attr`: Look up attribute `attr` inside the **child** module.
- `../attr`: Look up attribute `attr` inside the **parent** module.
